...
> 今回は8キーのキーボードにしようと思います

と言いましたが撤回。倍の 16 キーにして基板を作りました。マトリクス回路を使えばピン数を削減できるため Xiao RP2040 でもドライブできます
...
そして、キー割り当ては以下の通り。これだけあれば結構便利なんじゃないですかね？
...
基板は多めに刷ったので、Booth で頒布することにしました。リンクはこちら→ [Booth](https://nch-mosfet.booth.pm/items/4479337)
